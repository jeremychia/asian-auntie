...
A mobile-first app to track household perishables, prevent food waste, and get timely reminders about expiring items.

## Quick Links

- **[Problem Statement](problem-statement.md)** — Problem definition, user research findings, and user personas
...
- **[Future Features](future-features.yaml)** — v2+ roadmap ideas (recipe integration, analytics, household sharing, etc.)
- **[Open Questions](questions.yaml)** — Decisions still in progress, debates, and unknowns
